    ...
    public function bank($shop_id){
        ...
        if ($_POST) {
            ...
            if (!$error) {
                ...
                return redirect()->to(
                    base_url('shop/bank/' . $shop_id, 'refresh')
                );
            }
        }

        echo view('admin/header', $this->pageData);
        echo view('admin/shop/bank');
        echo view('admin/footer');
    }
    public function color($shop_id){
        if ($this->isMerchant == true) {
            $shop_id = $this->shop_id;
        ...
        if ($_POST) {
            ...
            if (!$error) {
                ...
                return redirect()->to(
                    base_url('shop/color/' . $shop_id, 'refresh')
                );
            }
        }

        echo view('admin/header', $this->pageData);
        echo view('admin/shop/color');
        echo view('admin/footer');
    }
    public function edit($shop_id)
    {
        ...
        if ($_POST) {
            ...
            if (!$error) {
                ...
                return redirect()->to(
                    base_url('shop/edit/' . $shop_id, 'refresh')
                );
            }
        }
