                            ...
                            <table class="table table-striped datatable table-bordered no-footer " id="voucher_list_table" data-method="get" data-url="<?= base_url("voucher") ?>" style="border-collapse: collapse !important">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th >Banner</th>
                                            <th data-sort="voucher" data-filter="voucher">Voucher</th>


                                            <th data-sort="description" data-filter="description">Description</th>
                                            <th data-sort="valid_until" data-filter="valid_until">Valid Until</th>
                                            <th data-sort="redeem_point" data-filter="redeem_point">Redeem Point</th>
                                            <th data-sort="is_active" data-filter="is_active">Is Active</th>
                                        ...
                                        <?php
                                         ...
                                         ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url() ?>/voucher/detail/<?= $row['voucher_id']?>"><?= $row['shop_name'] ?></a></td>
                                ...
                                <div class="custom_pagination" id="voucher_list_table" data-table="voucher_list_table" data-method="get" data-url="<?= base_url("voucher") ?>">
                                    <?= $page ?>
                                </div>
                            </div>
                        </div>
