<div class="c-subheader justify-content-between px-3">
    <ol class="breadcrumb border-0 m-0 px-0 px-md-3">
        ...
        <li class="breadcrumb-item active"><a href="<?= base_url() ?>Tag/add">Create New Tag</a></li>
    </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form role="form" method="POST" enctype="multipart/form-data" action="<?= base_url('/Tag/add'); ?>">
                                ...
                                <div class="form-group">
                                    <label for="">Tag</label>
                                    <input type="text" class="form-control" name="tag" placeholder="e.g. #jalan do , #jalan eat" required>
                                </div>
