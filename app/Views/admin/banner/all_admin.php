                ...
                <div id="" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table table-striped dataTable table-bordered no-footer " id="banner_list_table" data-method="get" data-url="<?= base_url(
                                    'banner'
					...
					<div class="col-md-12 animate-box">
                        <div class="dish-wrap">
							...
							<div class="addtocart">
                                <div class="dis-tc">
                                    <span><a href="<?= base_url() ?>/banner/edit/<?= $row[
    'banner_id'
] ?>"><i class="fa fa-pen fa-2x">Edit</i></a></span>
									<span><a href="<?= base_url() ?>/banner/detail/<?= $row[
    'banner_id'
] ?>"><i class="fa fa-eye fa-2x">View</i></a></span>
                                        <span><a href="<?= base_url() ?>/banner/delete/<?= $row[
    'banner_id'
            ...
            $row['banner'] ?>);"></div>
                                ...
                                <div class="custom_pagination" id="banner_list_table" data-table="banner_list_table" data-method="get" data-url="<?= base_url("banner") ?>">
                                    <?= $page ?>
                                </div>
                            </div>
                        </div>
