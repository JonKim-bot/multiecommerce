            ...
            <div class="card-body">
                <form role="form" method="POST" enctype="multipart/form-data" action="<?= base_url()?>/promo/edit/<?=$promo["promo_id"]?>">
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $promo['code'] ?>" name="code" placeholder="e.g. OFFER20" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="offer_amount">
                                    ...
                                    <input type="number" class="form-control" name="amount" value="<?= $promo['amount'] ?>" placeholder="e.g. RM5" >
                                </div>
                                
                                <div class="form-group" id="offer_percent">
                                    <label for="">Enter Promocode Offer Percent</label>
                                    <input type="number" class="form-control" name="percent" value="<?= $promo['percent'] ?>"  placeholder="e.g. 10%"   >
                                </div>
                                </div>
                    <div class="form-group">
