<div class="c-subheader justify-content-between px-3">
    <ol class="breadcrumb border-0 m-0 px-0 px-md-3">
        ...
        <li class="breadcrumb-item active"><a href="<?= base_url() ?>/promo/detail/<?= $promo[
    'promo_id'
] ?>">Promo Details</a></li>
    </ol>
                                ...
                                <div class="row">
                                    ...
                                    <?php if ($promo['is_active'] == 1) { ?>
                                        <a class="btn btn-primary" href="<?= base_url(
                                            ...
                                            '/' .
                                            $promo['promo_id'] ?>">Show</a>
                                        <?php } else { ?>
                                            <a class="btn btn-danger" href="<?= base_url(
                                                'promo/change_status/'
                                            ) .
                                                '/' .
                                                $promo['promo_id'] ?>">Hide</a>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($order_with_promo as $row) { ?>
                                            ...
                                            <td><?= $i ?></td>
                                                ...
                                                <td><a href="<?= base_url() ?>/orders/detail/<?= $row[
    'orders_id'
] ?>" target="_blank"><?= $row['contact'] ?></a></td>
                                                <td><a href="<?= base_url() ?>/orders/detail/<?= $row[
    'orders_id'
] ?>" target="_blank">RM <?= $row['grand_total'] ?></a></td>
