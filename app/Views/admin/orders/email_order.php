    ...
    <div class="invoice-box">
        <p>Below is your order on <?= $orders['created_date'] ?> in <?= $orders['shop_name'] ?></p>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <br>
                                Customer Name : <?= $orders['full_name'] ?><br>
                                Customer Email : <?= $orders['email'] ?><br>
                                Customer Contact : <?= $orders['contact'] ?>
