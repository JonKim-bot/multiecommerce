                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table datatable table-striped table-bordered no-footer " id="tag_list_table" data-method="get" data-url="<?= base_url("tag") ?>" style="border-collapse: collapse !important">
                                    <thead>
                                        <tr role="row">
                                            <th>No.</th>
                                        ...
                                        <?php
                                         ...
                                         ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url() ?>/tag/detail/<?= $row['tag_id']?>"><img src="<?= base_url() . $row['banner'] ?>" width="200px" alt=""></a></td>
