                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                        ...
                                        <?php
                                         ...
                                         ?>
                                            <tr>
                                                ...
                                                <td><a href="<?= base_url() ?>/customer/detail/<?= $row['customer_id']?>"><?= $row['shop_name'] ?></a></td>
                                ...
                                <div class="custom_pagination" id="customer_list_table" data-table="customer_list_table" data-method="get" data-url="<?= base_url("customer") ?>">
                                    <?= $page ?>
                                </div>
