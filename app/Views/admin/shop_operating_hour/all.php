        ...
        <div class="card">
            ...
            <div class="card-body">
                <div id="" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                    <a href="<?= base_url() .
                        '/special/specialtable' ?>" class="btn btn-primary">Switch To Table View</a>

                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table class="table table-striped datatable table-bordered no-footer " id="special_list_table" data-method="get" data-url="<?= base_url(
                                    'special'
                                ) ?>" style="border-collapse: collapse !important">
                                    <thead>
                                        <tr role="row">

                                            <th data-sort="name" data-filter="name">Special</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
					...
					<div class="col-md-12 animate-box">
                        <div class="dish-wrap">
							...
							<div class="addtocart">
                                <div class="dis-tc">
                                    <span><a href="<?= base_url() ?>/special/edit/<?= $row[
    'special_id'
] ?>"><i class="fa fa-pen fa-2x">Edit</i></a></span>
									<span><a href="<?= base_url() ?>/special/detail/<?= $row[
    'special_id'
] ?>"><i class="fa fa-eye fa-2x">View</i></a></span>
                                        <span><a href="<?= base_url() ?>/special/delete/<?= $row[
    'special_id'
