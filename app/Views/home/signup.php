...
<div id="piegen-page">
	...
	<input type="hidden" value="<?= $is_home ?>" name="" id="is_home">

	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-10">
			<?php if ($is_home != '') { ?>
				<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="<?= base_url() ?>/home/signup/<?= $is_home ?>">
			<?php } else { ?>
				<form class="login100-form validate-form" method="POST" enctype="multipart/form-data" action="<?= base_url() ?>/home/signup">
			<?php } ?>
					<span class="login100-form-title p-b-5">
						Sign Up To Piegen Emenu
					...
					<ul class="login-more p-t-10">
						...
						<li>
							...
							<a href="<?= base_url() ?>/home/login" class="txt2">
								Login
							</a>
						</li>
					</ul>
