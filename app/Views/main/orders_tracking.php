        ...
        <div class="card-body">
            ...
            <article class="card">
                ...
                <div class="col"> <strong>Prepared BY:</strong> <br> <?= $shop['shop_name'] ?>, | <i class="fa fa-phone"></i> <?= $shop['contact'] ?> </div>
                    ...
                    <div class="col"> <strong>Receipt #:</strong> <br> <a href="<?= base_url() . "/main/order_detail/" . $orders['orders_id'] ?>"><?= base_url() . "/main/<br>order_detail/" . $orders['orders_id'] ?></a> </div>
                </div>
            </article>
            <div class="track">
            ...
            <hr>
            <a href="<?= $orders['url'] ?>" class="btn btn-warning" data-abc="true"> <i class="fa fa-phone"></i> Contact Shop</a>
        </div>
    </article>
</div>