...
.slider-area.slider-area4,.slider-area2.slider-area4{
    background-image:url(../img/hero/hero4.jpg)
}
.slider-area.slider-area5,.slider-area2.slider-area5{
    background-image:url(../img/hero/hero5.jpg)
}
.slider-area .hero-caption,.slider-area2 .hero-caption{
    text-align:center
}
...
.slider-area .hero-caption h1,.slider-area2 .hero-caption h1{
    font-size:55px;
    font-weight:500;
    color:#292621;
    line-height:1.3;
...
.slider-area .hero-caption.hero-caption2 h2,.slider-area2 .hero-caption.hero-caption2 h2{
    color:#292621;
    font-size:35px;
    font-weight:500;
    margin-bottom:12px
...
.category-listing .single-listing .select-job-items1 .nice-select:focus,.category-listing .single-listing .select-job-items2 .nice-select:focus{
    border-color:#EEE1E0
}
